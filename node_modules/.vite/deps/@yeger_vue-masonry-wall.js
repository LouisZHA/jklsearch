...
var L = defineComponent({
  ...
  setup(a, { emit: p }) {
    ...
    }), onBeforeUnmount(() => o == null ? void 0 : o.unobserve(c.value)), watch([s, h], () => m(true)), watch([g, r], () => m()), (e, l) => (openBlock(), createElementBlock("div", {
      ref_key: "wall",
      ref: c,
      class: "masonry-wall",
...
var yeger_vue_masonry_wall_default = U;
export {
