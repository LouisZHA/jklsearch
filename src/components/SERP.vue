<template>
    ...
    <div class="bg-gray-50 ">
        <div v-if="results.length" v-for="item in results"
            class=" ml-5 mr-20 w-3/5 mt-5  max-w-70  bg-yellow-50 hover:bg-yellow-100 focus:ring-4 focus:ring-yellow-200 font-medium rounded-lg px-5 py-2.5 mb-2">
            <!-- {{results}} -->
    ...
    <footer
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/"
                class="hover:underline">JKL.IO</a>. All Rights Reserved.
        </span>
